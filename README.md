...
# AgroMetLLM: Evapotranspiration & Agro-Advisory System

---

## Overview

This project provides a **AgroMetLLM: web-based agrometeorological advisory tool** that combines weather data from [Open-Meteo](https://open-meteo.com/en/docs), advanced evapotranspiration (ET) calculations, and localized, farmer-friendly advice generated by local large language models (LLMs) running on a Raspberry Pi (or any compatible Linux host) via [Ollama](https://ollama.com/) on Raspberry Pi 4B an edge-IoT device.
